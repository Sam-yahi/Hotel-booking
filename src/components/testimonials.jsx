...
const Testimonials = () => {
    ...
    const CreateCard = ({ card, index }) => (
        <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0 animate-slide-in" style={{animationDelay: `${index * 0.1}s`}}>
        ...
        <>
            <div className="max-w-100% mx-auto px-6 md:px-16 lg:px-24 xl:px-18 py-16 flex flex-row justify-around ">
                <div className=" flex flex-col gap-5">
                    ...
                    <h5 className="text-center text-gray-700 ">Discover why discerning travelers consistently choose QuickStay for their exclusive and luxurious accommodations around the world.
                    </h5>
                </div>
            </div>
